...
var BlogArticleComponent = /** @class */ (function () {
    function BlogArticleComponent(router) {
        this.router = router;
    ...
    BlogArticleComponent.prototype.getDateStr = function (date) {
        return Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["formatDate"])(date, "dd/MM/yyyy", "en-US");
    };
    BlogArticleComponent.prototype.clickDelete = function (article) {
        this.clickDeleteEvent.emit(article);
    };
    BlogArticleComponent.prototype.clickRead = function (article) {
...
var BlogArticlesComponent = /** @class */ (function () {
    function BlogArticlesComponent(dbService) {
    ...
    BlogArticlesComponent.prototype.getArticles = function () {
        var _this = this;
        this.dbService.getAllArticles().subscribe(function (articles) { return _this.articles = articles; });
    };
    BlogArticlesComponent.prototype.clickArticleDelete = function (article) {
        this.dbService.deleteArticle(article._id);
        var articleIndex = this.articles.indexOf(article);
        if (articleIndex > -1) {
            this.articles.splice(articleIndex, 1);
        }
    };
    BlogArticlesComponent.prototype.onResize = function (event) {
        this.defineBreakpoint(event.target.innerWidth);
    };
    BlogArticlesComponent.prototype.defineBreakpoint = function (actualWidth) {
...
var BlogDbService = /** @class */ (function () {
    function BlogDbService(http) {
        this.http = http;
        this.apiUrl = "http://localhost:8000/api";
        this.articleUrl = this.apiUrl + "/article";
    }
    BlogDbService.prototype.getArticle = function (idArticle) {
        return this.http.get(this.articleUrl + "/" + idArticle);
    };
    BlogDbService.prototype.getAllArticles = function () {
        return this.http.get(this.articleUrl + "/all");
    };
    BlogDbService.prototype.createArticle = function (title, author, content) {
        var article = {
            title: title,
            date: new Date(),
            author: author,
        ...
        this.http.post(this.articleUrl, body).subscribe(function (res) { });
    };
    BlogDbService.prototype.deleteArticle = function (idArticle) {
        var body = {
            id: idArticle,
            type: 'DELETE'
        };
...
var BlogFormCreateArticleComponent = /** @class */ (function () {
    function BlogFormCreateArticleComponent(dbService, router) {
        this.dbService = dbService;
        this.router = router;
    ...
    BlogFormCreateArticleComponent.prototype.ngOnInit = function () {
    };
    BlogFormCreateArticleComponent.prototype.onArticleSubmit = function () {
        var title = this.articleForm.controls.title.value;
        var author = this.articleForm.controls.author.value;
        var content = this.articleForm.controls.content.value;
    ...
    return BlogFormCreateArticleComponent;
}());
...
var BlogFormReadArticleComponent = /** @class */ (function () {
    function BlogFormReadArticleComponent(route, dbService) {
        this.route = route;
        this.dbService = dbService;
    }
    BlogFormReadArticleComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.subscribe(function (params) {
            _this.id = params.get("id");
            _this.dbService.getArticle(_this.id).subscribe(function (article) { return _this.article = article; });
        });
    };
    BlogFormReadArticleComponent.prototype.getDateStr = function (date) {
    ...
    return BlogFormReadArticleComponent;
}());
...
var BlogNavbarComponent = /** @class */ (function () {
    function BlogNavbarComponent() {
    }
    BlogNavbarComponent.prototype.ngOnInit = function () {
    };
...
var BlogPageHomeComponent = /** @class */ (function () {
    function BlogPageHomeComponent() {
    }
    BlogPageHomeComponent.prototype.ngOnInit = function () {
    };
